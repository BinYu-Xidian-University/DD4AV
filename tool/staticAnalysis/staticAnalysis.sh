...
if [ ! -s ./static_analysis.$NAME ]; then
    echo "[*] Generating crucial info for AV ----KeLei"
    rm -f ./static_analysis.$NAME
    ${ROOT_DIR}/tool/staticAnalysis/get_aliased_info_copy.py ./mssa.$NAME > ./static_analysis.$NAME
fi
