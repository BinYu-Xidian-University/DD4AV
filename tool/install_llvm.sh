...
if [ $(command uname) = "Darwin" ]; then
	...
	# For Linux
	wget -c -e "https_proxy=http://127.0.0.1:7897" https://github.com/llvm/llvm-project/releases/download/llvmorg-10.0.0/clang+llvm-10.0.0-x86_64-linux-gnu-ubuntu-18.04.tar.xz
