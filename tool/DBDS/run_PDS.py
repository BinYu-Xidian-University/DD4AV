...
def setup_share_memroy():
    IPC_KEY, MAP_SIZE, IPC_CREAT, IPC_EXCL = 1111, sizeof(c_ulonglong) + sizeof(c_uint) * 3 + sizeof(c_uint16) * (
                SHARE_THREAD_NUM + 3 * SHARE_ARRAY_SIZE), 512, 1024
    ...
    if VarModeFlag == 0 or iterPeriod == 2:
        ...
        if directInterList != []:
            ...
            if CurdirectInter != []:
                ...
                try:
                    scheduler = SBPMESched(N + zero_num(useful_kp_num_list, [0] * SHARE_THREAD_NUM, N),
    ...
    while True:
                ...
                try:
                    ...
                    if DebugInfo:
                        ...
                        print_Info_from_shm(A.value, B.value, T.value, kpNumArray, kpYieldArray, kpLocArray,
                                            kpOrderArray, prefixPrint, coverage_hashID, zero_in_KP, False)
        ...
        if DBDS_stage == 2:
            ...
            while waited_to_explore:
                ...
                try:
                    scheduler = SBPMESched(tempL[2], tmpMList, iterPeriod, prefix)  # Mengda Add
                except:
