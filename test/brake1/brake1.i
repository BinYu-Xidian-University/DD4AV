...
extern int renameat (int __olbrake1d, const char *__old, int __newfd,
...
extern int select (int __nfds, fd_set *__restrict __reabrake1ds,
     fd_set *__restrict __writefds,
     fd_set *__restrict __exceptfds,
     struct timeval *__restrict __timeout);
# 113 "/usr/include/x86_64-linux-gnu/sys/select.h" 3 4
extern int pselect (int __nfds, fd_set *__restrict __reabrake1ds,
      fd_set *__restrict __writefds,
      fd_set *__restrict __exceptfds,
...
# 5 "svp_simple_004_001.c" 2
# 37 "svp_simple_004_001.c"
...
# 281 "svp_simple_004_001.c" 3 4
       _Bool 
# 281 "svp_simple_004_001.c"
        ...
        if (tmp0 > tmp1) {
            rtb_RelationalOperator = 
# 310 "svp_simple_004_001.c" 3 4
                                    1
# 310 "svp_simple_004_001.c"
                                        ;
        } else {
            rtb_RelationalOperator = 
# 312 "svp_simple_004_001.c" 3 4
                                    0
# 312 "svp_simple_004_001.c"
                                         ;
        }
    ...
    brake_acc_nodiv_ctrl_B_local_RT4 = RT4_Buffer0;
# 386 "svp_simple_004_001.c"
    
# 386 "svp_simple_004_001.c" 3 4
   _Bool 
# 386 "svp_simple_004_001.c"
        rtb_RelationalOperator;
    int rtb_vms;
    ...
    if (tmp0 > tmp1) {
        rtb_RelationalOperator = 
# 420 "svp_simple_004_001.c" 3 4
                                1
# 420 "svp_simple_004_001.c"
                                    ;
    } else {
        rtb_RelationalOperator = 
# 422 "svp_simple_004_001.c" 3 4
                                0
# 422 "svp_simple_004_001.c"
                                     ;
    }
...
void *task_FR_Wheel(void *unused)
{
 ...
 rtb_to_int_k = 10;
# 514 "svp_simple_004_001.c"
    
# 514 "svp_simple_004_001.c" 3 4
   _Bool 
# 514 "svp_simple_004_001.c"
        rtb_RelationalOperator;
...
# 543 "svp_simple_004_001.c"
    int tmp0 = 10;
    int tmp1 = 10 + rtb_vms;
    if (tmp0 > tmp1) {
        rtb_RelationalOperator = 
# 546 "svp_simple_004_001.c" 3 4
                                1
# 546 "svp_simple_004_001.c"
                                    ;
    } else {
        rtb_RelationalOperator = 
# 548 "svp_simple_004_001.c" 3 4
                                0
# 548 "svp_simple_004_001.c"
                                     ;
    }
...
# 609 "svp_simple_004_001.c" 3 4
   _Bool 
# 609 "svp_simple_004_001.c"
        rtb_RelationalOperator;
    int rtb_vms;
    int u;
    rtb_vms = 10 + brake_acc_nodiv_ctrl_B_local_RT4;
...
# 635 "svp_simple_004_001.c"
    int tmp0 = 10;
    int tmp1 = 10 + rtb_vms;
    if (tmp0 > tmp1) {
        rtb_RelationalOperator = 
# 638 "svp_simple_004_001.c" 3 4
                                1
# 638 "svp_simple_004_001.c"
                                    ;
    } else {
        rtb_RelationalOperator = 
# 640 "svp_simple_004_001.c" 3 4
                                0
# 640 "svp_simple_004_001.c"
                                     ;
    }
