...
int main(int argc, char **argv) {
    ...
    */
    ...
    // pthread_create(&id1, NULL, (void*)task_compute, NULL);
    pthread_create(&id2, NULL, (void*)task_RR_Wheel_isr,NULL);	
    pthread_create(&id3, NULL, (void*)task_FL_Wheel_isr, NULL);
    pthread_create(&id4, NULL, (void*)task_FR_Wheel_isr, NULL);
