...
cd $ROOT_DIR/rxlitest/2.1_remarks/svp_simple_003
./cleanDIR.sh
clang -g -O0 -emit-llvm -c ./svp_simple_003_001.c -o svp_simple_003_001.bc

# perform static analysis
$ROOT_DIR/tool/staticAnalysis/staticAnalysis.sh svp_simple_003_001

# complie the instrumented program with ASAN
export Con_PATH=$ROOT_DIR/rxlitest/2.1_remarks/svp_simple_003/ConConfig.svp_simple_003_001
