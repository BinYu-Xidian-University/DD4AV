...
export Con_PATH=$ROOT_DIR/rxlitest/test/ConConfig.test
$ROOT_DIR/tool/staticAnalysis/DBDS-INSTRU/dbds-clang-fast -g -O0 -fsanitize=address -c ./test.c -o test.o
